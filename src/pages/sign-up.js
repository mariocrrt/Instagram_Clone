    ...
    return(
        <div className='container flex mx-auto max-w-screen-md items-center h-screen'>
            <div className='flex w-3/5'>
                <img src='/images/iphone-with-profile.jpg' alt='iPhone with Instagramm app' />
            </div>
                ...
                <div className='flex flex-col items-center bg-white p-4 border border-gray-300 mb-4 rounded'>
                    ...
                    <form onSubmit={handleSignUp} method='POST'>
                        <input 
                            ...
                            className='text-sm text-gray-600 w-full mr-3 py-5 px-4 h-2 border border-gray-300 rounded mb-2'
